...
public class DechiffrementRotation {
    ...
    public static String dechiffrementRotation(String message) {
        try ( // Création d'un objet Scanner pour lire les entrées de l'utilisateur
            ...
            for (int i = 0; i < message.length(); i++) {
                ...
                // (ci - 'a') : Conversion du caractère en une position "normal" dans l'alphabet (a
                // = 0,
                ...
                // + 'a' : Conversion de la position "normal" en un caractère de l'alphabet ASCII
                // pour
                // que l'ordinateur puisse comprendre
                char charDechiffre = (char) (((ci - 'a' - decalage) % 26) + 'a');
                // Affiche le message déchiffré
                message = message.replace(ci, charDechiffre);
